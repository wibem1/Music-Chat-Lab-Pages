const CACHE_NAME = "music-chat-lab-v0-4-15";
const APP_SHELL = [
  "./styles.css?v=0.4.15",
  "./app.js?v=0.4.15",
  "./music-file-processing.js?v=0.4.15",
  "./engine14-output.js?v=0.4.15",
  "./concept-approval.js?v=0.4.15",
  "./android-download-fix.js?v=0.4.15",
  "./manifest.webmanifest?v=0.4.15",
  "./icon.svg?v=0.4.15"
];
