const CACHE_NAME = "music-chat-lab-v1-1-6";
const APP_SHELL = [
  "./","./index.html",
  "./styles.css?v=1.0.20","./ui-fixes.css?v=1.0.20","./app.js?v=1.1.1","./composition-state-fix.js?v=1.1.6","./usage-costs.js?v=1.1.4",
  ...
  "./midi-export.js?v=1.0.20","./ui-enhancements.js?v=1.1.6",
