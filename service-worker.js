const CACHE_NAME = "music-chat-lab-v0-4-20";
const APP_SHELL = [
  "./styles.css?v=0.4.20",
  "./app.js?v=0.4.20",
  "./music-file-processing.js?v=0.4.20",
  "./engine14-output.js?v=0.4.20",
  "./concept-approval.js?v=0.4.20",
  "./android-download-fix.js?v=0.4.20",
