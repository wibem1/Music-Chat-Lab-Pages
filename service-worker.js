const CACHE_NAME = "music-chat-lab-v1-1-12";
const APP_SHELL = [
  "./","./index.html",
  "./styles.css?v=1.0.20","./ui-fixes.css?v=1.0.20","./app.js?v=1.1.1","./composition-state-fix.js?v=1.1.9","./usage-costs.js?v=1.1.4",
  "./music-file-processing.js?v=1.0.20","./download-compat.js?v=1.0.20",
  "./api-usage.js?v=1.1.1","./composition-engine14.js?v=1.1.5","./concept-approval.js?v=1.1.11","./concept-openai.js?v=1.1.11",
