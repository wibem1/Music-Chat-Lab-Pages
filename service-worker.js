const CACHE_NAME = "music-chat-lab-v0-4-21";
const APP_SHELL = [
  "./styles.css?v=0.4.21",
  "./app.js?v=0.4.21",
  "./music-file-processing.js?v=0.4.21",
  "./engine14-output.js?v=0.4.21",
  "./concept-approval.js?v=0.4.21",
  "./android-download-fix.js?v=0.4.21",
  "./manifest.webmanifest?v=0.4.21",
  "./icon.svg?v=0.4.21"
];
