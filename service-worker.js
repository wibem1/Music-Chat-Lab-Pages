const CACHE_NAME = "music-chat-lab-v0-4-17";
const APP_SHELL = [
  "./styles.css?v=0.4.17",
  "./app.js?v=0.4.17",
  "./music-file-processing.js?v=0.4.17",
  "./engine14-output.js?v=0.4.17",
  "./concept-approval.js?v=0.4.17",
  "./android-download-fix.js?v=0.4.17",
  "./manifest.webmanifest?v=0.4.17",
  "./icon.svg?v=0.4.17"
];
