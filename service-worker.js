const CACHE_NAME = "music-chat-lab-v1-1-33";
const APP_SHELL = [
  "./","./index.html",
  ...
  "./api-usage.js?v=1.1.16","./composition-engine14.js?v=1.1.5","./request-control.js?v=1.1.33","./composition-architecture.js?v=1.1.31",
