const CACHE_NAME = "music-chat-lab-v1-2-0";
const APP_SHELL = [
  "./","./index.html",
  "./styles.css?v=1.0.20","./ui-fixes.css?v=1.1.18","./app.js?v=1.1.30","./composition-state.js?v=1.2.0","./usage-costs.js?v=1.1.18",
  "./music-file-processing.js?v=1.0.20","./download-compat.js?v=1.0.20",
  "./api-usage.js?v=1.1.16","./composition-engine14.js?v=1.1.5","./composition-edit.js?v=1.1.22","./composition-controller.js?v=1.2.0",
  "./midi-player.js?v=1.0.20","./midi-stop-reset.js?v=1.0.20","./midi-slot-restore.js?v=1.0.20","./midi-input-sync.js?v=1.1.10",
  "./midi-playback-scheduler.js?v=1.0.22","./midi-context.js?v=1.1.20",
  "./clab-document-v1.js?v=1.1.3","./clab-assignment-fix.js?v=1.1.23",
  "./chat-delete.js?v=1.0.20","./chat-titles.js?v=1.0.20","./midi-memory.js?v=1.1.8","./midi-slot-delete.js?v=1.0.20",
  "./midi-export.js?v=1.0.20","./backup-manager.js?v=1.2.0","./ui-enhancements.js?v=1.2.0","./diagnostic-enhancer.js?v=1.1.22",
