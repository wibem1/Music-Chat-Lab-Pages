const CACHE_NAME = "music-chat-lab-v0-4-22";
const APP_SHELL = [
  "./styles.css?v=0.4.22",
  "./app.js?v=0.4.22",
  "./music-file-processing.js?v=0.4.22",
  "./engine14-output.js?v=0.4.22",
  "./concept-approval.js?v=0.4.22",
  "./chat-delete.js?v=0.4.22",
  "./android-download-fix.js?v=0.4.22",
