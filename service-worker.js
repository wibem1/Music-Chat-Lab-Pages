const CACHE_NAME = "music-chat-lab-v0-4-16";
const APP_SHELL = [
  "./styles.css?v=0.4.16",
  "./app.js?v=0.4.16",
  "./music-file-processing.js?v=0.4.16",
  "./engine14-output.js?v=0.4.16",
  "./concept-approval.js?v=0.4.16",
  "./android-download-fix.js?v=0.4.16",
  "./manifest.webmanifest?v=0.4.16",
  "./icon.svg?v=0.4.16"
];
