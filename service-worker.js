const CACHE_NAME = "music-chat-lab-v0-4-14";
const APP_SHELL = [
  "./styles.css?v=0.4.14",
  "./app.js?v=0.4.14",
  "./music-file-processing.js?v=0.4.14",
  "./engine14-output.js?v=0.4.14",
  "./concept-approval.js?v=0.4.14",
  "./android-download-fix.js?v=0.4.14",
  "./manifest.webmanifest?v=0.4.14",
  "./icon.svg?v=0.4.14"
];
