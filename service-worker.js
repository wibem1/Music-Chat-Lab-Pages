const CACHE_NAME = "music-chat-lab-v0-4-18";
const APP_SHELL = [
  "./styles.css?v=0.4.18",
  "./app.js?v=0.4.18",
  "./music-file-processing.js?v=0.4.18",
  "./engine14-output.js?v=0.4.18",
  "./concept-approval.js?v=0.4.18",
  "./android-download-fix.js?v=0.4.18",
  "./manifest.webmanifest?v=0.4.18",
  "./icon.svg?v=0.4.18"
];
