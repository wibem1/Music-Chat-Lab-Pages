const CACHE_NAME = "music-chat-lab-v1-3-5";
const APP_SHELL = [
  "./","./index.html",
  ...
  "./api-usage.js?v=1.1.16","./composition-engine14.js?v=1.1.5","./request-control.js?v=1.1.35","./explicit-mode-v134.js?v=1.3.4","./session-orchestrator-v132.js?v=1.3.2",
