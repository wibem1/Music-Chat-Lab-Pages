const CACHE_NAME = "music-chat-lab-v0-4-19";
const APP_SHELL = [
  "./styles.css?v=0.4.19",
  "./app.js?v=0.4.19",
  "./music-file-processing.js?v=0.4.19",
  "./engine14-output.js?v=0.4.19",
  "./concept-approval.js?v=0.4.19",
  "./android-download-fix.js?v=0.4.19",
  "./manifest.webmanifest?v=0.4.19",
  "./icon.svg?v=0.4.19"
];
