const CACHE_NAME = "music-chat-lab-v1-3-7";
const APP_SHELL = [
  "./","./index.html",
  "./styles.css?v=1.0.20","./ui-fixes.css?v=1.1.18","./explicit-mode-v133.css?v=1.3.5","./app.js?v=1.1.13","./composition-state-fix.js?v=1.1.9","./usage-costs.js?v=1.1.18",
  "./music-file-processing.js?v=1.0.20","./download-compat.js?v=1.0.20",
  "./api-usage.js?v=1.1.16","./composition-engine14.js?v=1.1.5","./request-control.js?v=1.1.35","./explicit-mode-v134.js?v=1.3.6","./session-orchestrator-v132.js?v=1.3.2","./variant-player-fixes-v137.js?v=1.3.7",
