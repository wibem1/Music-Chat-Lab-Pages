const CACHE_NAME = "music-chat-lab-v1-3-0";
const APP_SHELL = [
  "./","./index.html",
  ...
  "./api-usage.js?v=1.1.16","./composition-engine14.js?v=1.1.5","./request-control.js?v=1.1.35","./session-orchestrator-v12.js?v=1.3.0",
