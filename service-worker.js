const CACHE_NAME = "music-chat-lab-v1-0-14";
const APP_SHELL = ["./","./index.html","./styles.css?v=1.0.14","./app.js?v=1.0.14","./midi-context.js?v=1.0.14","./music-file-processing.js?v=1.0.14","./engine14-output.js?v=1.0.14","./concept-approval.js?v=1.0.14","./request-control.js?v=1.0.14","./chat-delete.js?v=1.0.14","./chat-titles.js?v=1.0.14","./android-download-fix.js?v=1.0.14","./midi-player.js?v=1.0.14","./midi-slot-stability.js?v=1.0.14","./midi-load-fix.js?v=1.0.14","./apk-playback-v11.js?v=1.0.14","./midi-memory.js?v=1.0.14","./midi-slot-delete.js?v=1.0.14","./update-manager.js?v=1.0.14","./manifest.webmanifest?v=1.0.14","./icon.svg?v=1.0.14"];
