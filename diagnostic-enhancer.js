...
function buildDiagnostic(){const base=readJSON(DIAG_KEY,{});return{...base,diagnosticFormat:2,appVersion:'1.1.19',capturedAt:new Date().toISOString(),chatContext:chatSnapshot(),pendingCompositions:pendingSnapshot(),workspace:workspaceSnapshot()}}
